  ...
  "",
  {
    variants: {
      variant: {
        ...
        underline: "z-10 bg-primary data-[orientation=horizontal]:h-0.5 data-[orientation=vertical]:w-0.5 data-[orientation=vertical]:-translate-x-px data-[orientation=horizontal]:translate-y-px",
      },
    },
    defaultVariants: {
      variant: "default",
